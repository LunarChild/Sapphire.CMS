...
namespace Sapphire.Core.Upload
{
    ...
    /// 上传提供者。
    /// </summary>
    public abstract class GeneralFieldUploadProvider : IUploadProvider, IGeneralFieldUploadConfig
    {
        ...
        public abstract IUploadConfig GetUploadConfig();

        /// <summary>
        /// 获取上传提供者的键。
        /// </summary>
        /// <returns>上传提供者的键。</returns>
        public virtual string GetUploadProviderKey()
        {
